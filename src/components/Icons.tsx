...
export function IcOutlineLyrics(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
      ...
      {...props}
    >
      <path fill="currentColor" d="M6 6h7v2H6zm0 6h4v2H6z"></path>
      <path
        fill="currentColor"
...
export function IcBaselineLyrics(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
    ...
    >
      ...
      <path
        fill="currentColor"
        d="M20 6.18c-.31-.11-.65-.18-1-.18c-1.66 0-3 1.34-3 3s1.34 3 3 3s3-1.34 3-3V3h2V1h-4v5.18z"
      ></path>
    </svg>
  );
}
