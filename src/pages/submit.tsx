...
const Submit: NextPage = () => {
  ...
  if (isNewArtist && newArtistName !== watch("artistName")) {
    setIsNewArtist(false);
    setNewArtistName("");
  }
  if (isNewSong && newSongName !== watch("songName")) {
    setIsNewSong(false);
    setNewSongName("");
  }
      ...
      <form action="" autoComplete="off">
        <div className="mb-5 rounded-lg bg-gray-900 p-5">
          ...
          <input type="hidden" {...register("artistId")} />
          {
            ...
            isNewArtist && newArtistName === watch("artistName") && (
        ...
        </div>
        {
          ...
          ((getValues("artistId") && getValues("artistId").length !== 0) ||
            isNewArtist) && (
            <div
            ...
            >
              ...
              <input type="hidden" {...register("songId")} />
              {
                ...
                (isNewArtist || isNewSong) &&
                  newSongName === watch("songName") && (
                    <div className="bg-red-900">
                      ...
                      <select className="bg-gray-800" {...register("language")}>
        ...
        {((getValues("songId") && getValues("songId").length !== 0) ||
          isNewSong) && (
          <div className="mb-5 rounded-lg bg-gray-900 p-5">
            ...
            <div className="flex">
              <div>
                ...
                <select
                  value={isNewSong ? getValues("language") : songData?.language}
                  disabled
